...
function FinalInvoice() {
  ...
  const [remainingAmount, setRemainingAmount] = useState(0); // State to hold the remaining amount
  ...
  const fetchInvoices = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        setRemainingAmount(actualPriceTotal - offerPriceTotal);
      }
    } catch (error) {
    ...
    <>
      <div className="container-fluid">
        ...
        <div className="container-fluid mt-4">
          <div className="row g-2">
            <div className="col-lg-3">
              {" "}
              <Link to="/" className="text-white btn btn-success  mx-1  w-100">
                {" "}
        ...
        <div className="container-fluid">
              ...
              <table className="table table-bordered ">
                <thead>
                  <tr>
                    ...
                    <th>Actual Amt(INR)</th>
                    {/* <th>Offer Price(INR)</th> */}
                    <th>Paid Amt(INR)</th>
                    <th>Remaining Amt(INR)</th>
                    <th>Subscription</th>
                    <th>Action</th>
                  </tr>
                </thead>
                <tbody>
                  {filterServicesByType("Paid").map((q, index) => (
                    <tr key={q.id}>
                      ...
                      <td className="th">{remainingAmount}</td>
          ...
          {/* Remaining Amount */}
          <div className="container-fluid mt-4">
            <h5>Remaining Amount: ₹{remainingAmount}</h5>
          </div>
